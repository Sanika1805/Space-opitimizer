  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center px-4">
      <div className="w-full max-w-md bg-white rounded-xl shadow-lg border border-green-100 p-8">
        <h2 className="text-2xl font-bold text-green-800 mb-2">Incharge Login</h2>
        <p className="text-sm text-gray-600 mb-6">
          Verify with your credentials. Apply as incharge from dashboard after signup if needed.
        </p>
        {error && (
        ...
        <p className="mt-4 text-center text-sm text-gray-600">
          Regular user? <Link to="/login" className="text-green-600 font-medium hover:underline">Login here</Link>
        </p>
      </div>
    </div>
  );
